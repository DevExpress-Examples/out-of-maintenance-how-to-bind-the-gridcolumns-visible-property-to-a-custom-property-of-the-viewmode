...
Namespace WpfApplication1
    Public Class ViewModel
        ...
        Public Sub CreateData()
            ListItem = New BindingList(Of ContactItem)() From { _
                New ContactItem() With {.Name = "First sample name", .Salary = 13R, .Date = Date.Today, .IsFired = False}, _
                New ContactItem() With {.Name = "Second sample name", .Salary = 13R, .Date = Date.Today, .IsFired = False} _
            }
        End Sub
